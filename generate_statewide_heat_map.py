"""
Generate a one-time statewide extreme heat map for California.
"""
...
if __name__ == "__main__":
    ...
    topical_data_path = 'inputs/heat_data.csv'
    ...
    print(f"Statewide extreme heat map generated: {output_file}")
